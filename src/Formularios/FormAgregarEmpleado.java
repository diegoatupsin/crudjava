...
public class FormAgregarEmpleado extends javax.swing.JFrame {
    ...
    public FormAgregarEmpleado(EmpleadosPanel empleadosPanel) {
        this.empleadosPanel = empleadosPanel;
        
        initComponents();
        
        Image icon = Toolkit.getDefaultToolkit().getImage(FormAgregarEmpleado.class.getResource("/Imagenes/logoFlor.png"));
        setIconImage(icon);
