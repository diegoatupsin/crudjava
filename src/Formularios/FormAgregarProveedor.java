...
public class FormAgregarProveedor extends javax.swing.JFrame {
    ...
    public FormAgregarProveedor(ProveedoresPanel proveedoresPanel) {
        this.proveedoresPanel = proveedoresPanel;
        
        initComponents();
        
        Image icon = Toolkit.getDefaultToolkit().getImage(FormAgregarProveedor.class.getResource("/Imagenes/logoFlor.png"));
        setIconImage(icon);
    ...
    private void guardarProveedor() {
        ...
        String nombre = txtfNombreProv.getText().trim();
        ...
        if (!nombre.isEmpty()) {
            ...
            prov.setNombreProv(txtfNombreProv.getText().trim());
            prov.setDireccionProv(txtfDireccionProv.getText().trim());
            prov.setRFCProv(txtfRFCProv.getText().trim());
            prov.setNumeroProv(telefonos); // set telefonos
            prov.setCorreoProv(correos);
